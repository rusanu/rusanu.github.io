...
date: 2014-01-10T05:36:08+00:00
author: remus
layout: revision
guid: http://rusanu.com/2014/01/10/2144-revision-22/
permalink: /2014/01/10/2144-revision-22/
---
...
Is this situation unusual, having most (or even all) requests waiting, rather than executing? Not at all, this is the norm! Any time you will look at a SQL Server executing an even moderate load, you&#8217;ll see that most requests are waiting and only a few are executing. From a performance troubleshooting perspective, this is a key observation: to make your requests respond faster you need to have them be executing rather than waiting.