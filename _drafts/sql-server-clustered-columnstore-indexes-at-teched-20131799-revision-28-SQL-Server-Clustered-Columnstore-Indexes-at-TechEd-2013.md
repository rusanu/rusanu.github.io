...
date: 2013-06-11T05:18:18+00:00
author: remus
layout: revision
guid: http://rusanu.com/2013/06/11/1799-revision-28/
permalink: /2013/06/11/1799-revision-28/
---
...
Workload Variation
:   Columnstore index build is very memory intensive. Traditional execution model determines the DOP at beginning of execution and then the query executes with the given DOP. With the improved columnstore build the actual execution DOP varies as the build progresses 

:   
minimize blocking during the index build and adapt to concurrent workload changes.
