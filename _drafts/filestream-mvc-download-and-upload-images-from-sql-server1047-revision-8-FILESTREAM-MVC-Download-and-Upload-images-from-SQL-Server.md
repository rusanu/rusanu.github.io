...
date: 2011-02-05T12:05:05+00:00
author: remus
layout: revision
guid: http://rusanu.com/2011/02/05/1047-revision-8/
permalink: /2011/02/05/1047-revision-8/
---
...
create database images 
	...
	, filegroup FS contains FILESTREAM (name = 'images_files', filename='c:\temp\images_files')
	log on (name='images_log', filename='c:\temp\images.ldf');
go
</code>
</pre>

The media table used by our MVC project is going to look the same as the one used in the previous article, except that the <tt>content</tt> column will have the FILESTREAM attribute added:
