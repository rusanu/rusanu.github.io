...
date: 2011-02-05T12:06:48+00:00
author: remus
layout: revision
guid: http://rusanu.com/2011/02/05/1047-revision-10/
permalink: /2011/02/05/1047-revision-10/
---
...
## a FILESTREAM based IMediaRepository
...
The media table used by our MVC project is going to be similar to the one used in the previous article but the <tt>content</tt> column will have the FILESTREAM attribute added. A table that has FILESTREAM columns is also required to have a ROWGUID column, so we&#8217;re going to add one of those as well:
...
create table media (
	...
	[media_rowguid] uniqueidentifier not null ROWGUIDCOL UNIQUE default newsequentialid() ,
