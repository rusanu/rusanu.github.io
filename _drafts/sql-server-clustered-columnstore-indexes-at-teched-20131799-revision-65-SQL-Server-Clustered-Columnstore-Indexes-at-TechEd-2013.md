...
date: 2013-06-11T06:27:54+00:00
author: remus
layout: revision
guid: http://rusanu.com/2013/06/11/1799-revision-65/
permalink: /2013/06/11/1799-revision-65/
---
...
Enjoy! SELECT &#8230; INTO has always been a bulk (and minimally logged) operation, but that can only create a row-mode heap. With INSERT &#8230; SELECT being now optimized for clustered columnstore indexes to use the bulk insert API the ETL pipeline can construct the switch-in data directly into columnar storage format in one single pass, w/o having to resort to a rebuild. This is, again, described in the SIGMOD paper.
