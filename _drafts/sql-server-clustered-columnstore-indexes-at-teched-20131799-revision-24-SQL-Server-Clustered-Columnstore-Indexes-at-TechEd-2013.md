...
date: 2013-06-11T04:27:12+00:00
author: remus
layout: revision
guid: http://rusanu.com/2013/06/11/1799-revision-24/
permalink: /2013/06/11/1799-revision-24/
---
...
<blocquote>Large bulk insert operations do not insert rows into delta stores but convert batches of rows directly into columnar format. The operation buffers rows until a sufficient number of rows has accumulated, converts them into columnar format, and writes the resulting segments and dictionaries to disk. This is very efficient; it reduces the IO requirements and immediately produces the columnar format needed for fast scans. The downside is the large memory space needed to buffer rows.</blockquote>