...
date: 2010-04-23T11:39:16+00:00
author: remus
layout: revision
guid: http://rusanu.com/2010/04/23/764-revision-17/
permalink: /2010/04/23/764-revision-17/
---
  ...
  <colgroup> <col width="25%" style="background-color:lightgray"/> <col width="25%"/> <col width="25%"/> <col width="25%"/> </colgroup> <tr style="background-color:lightgray">
    ...
    <td>
      ...
      <ol>
        ...
        <li>
          Optionally change the mirror endpoint to DISABLED
        </li>
        <li>
          Verify that the connections are encrypted, check sys.dm_db_mirroring_connections
        </li>
      </ol>
      
      <p>
        This way there are two
      </p>