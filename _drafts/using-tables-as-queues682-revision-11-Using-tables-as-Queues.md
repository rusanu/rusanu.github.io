...
date: 2010-03-06T12:50:25+00:00
author: remus
layout: revision
guid: http://rusanu.com/2010/03/06/682-revision-11/
permalink: /2010/03/06/682-revision-11/
---
...
The reason why OUTPUT clause is critical is that it offers an atomic destructive read operation that allows us to remove the dequeued row _and_ return it to the caller, in one single statement. Historically this was a problem and applications had to 
...
A heap queue can satisfy most producer-consumer patterns. It scales well and